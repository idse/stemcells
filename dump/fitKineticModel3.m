function output = fitKineticModel3(input,alpha)
% fit Smad4 kinetic model to FRAP data
% 
% version 3: fit all 3 conditions at once
%
...
f = @(p) [  (A(p(1),p(2),p(3),p(4)) - input{1}.A)/input{1}.sigA,...
            (R(p(1),p(2),p(3),p(4)) - input{1}.R)/input{1}.sigR,...
