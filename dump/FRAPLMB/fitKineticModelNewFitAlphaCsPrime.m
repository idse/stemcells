...
f = @(p) [  ( An(p(1),p(2),p(3),p(4))         - input{1}.A)/input{1}.sigA,...
            ...
            ( R(p(1),p(2),p(3),p(4))*p(19)  - input{1}.r)/input{1}.sigr,...
            ...
            ( An(p(1),p(5),p(6),p(4))         - input{1}.Almb)/input{1}.sigAlmb,...
            ( Ac(p(1),p(5),p(6),p(4))      - input{1}.Aclmb)/input{1}.sigAclmb,...
            ( k(p(1),p(5))                   - input{1}.klmb)/input{1}.sigklmb,...
            ( R(p(1),p(5),p(6),p(4))*p(19)  - input{1}.rlmb)/input{1}.sigrlmb,...
            ...
            ( An(p(7),p(8),p(9),p(10))         - input{2}.A)/input{2}.sigA,...
            ( Ac(p(7),p(8),p(9),p(10))      - input{2}.Ac)/input{2}.sigAc,...
            ( k(p(7),p(8))                   - input{2}.k)/input{2}.sigk,...
            ( R(p(7),p(8),p(9),p(10))*p(19)  - input{2}.r)/input{2}.sigr,...
            ...
            ( An(p(7),p(11),p(12),p(10))        - input{2}.Almb)/input{2}.sigAlmb,...
            ( Ac(p(7),p(11),p(12),p(10))    - input{2}.Aclmb)/input{2}.sigAclmb,...
            ( k(p(7),p(11))                  - input{2}.klmb)/input{2}.sigklmb,...
            ( R(p(7),p(11),p(12),p(10))*p(19)  - input{2}.rlmb)/input{2}.sigrlmb,...
            ...
            ( An(p(13),p(14),p(15),p(16))     - input{3}.A)/input{3}.sigA,...
            ( Ac(p(13),p(14),p(15),p(16))  - input{3}.Ac)/input{3}.sigAc,...
            ( k(p(13),p(14))                 - input{3}.k)/input{3}.sigk,...
            ( R(p(13),p(14),p(15),p(16))*p(19)  - input{3}.r)/input{2}.sigr,...
            ...
            ( An(p(13),p(17),p(18),p(16))     - input{3}.Almb)/input{3}.sigAlmb,...
            ( Ac(p(13),p(17),p(18),p(16))  - input{3}.Aclmb)/input{3}.sigAclmb,...
            ( k(p(13),p(17))                 - input{3}.klmb)/input{3}.sigklmb,...
            ( R(p(13),p(17),p(18),p(16))*p(19)  - input{3}.rlmb)/input{2}.sigrlmb];
...
pinit = [kout0 kin0 cs0 ns0 koutp0 csp0];
...
for i = 1:3
    output{i}.kin = pfit(6*(i-1)+1);
    output{i}.kout = pfit(6*(i-1)+2);
    output{i}.cs = pfit(6*(i-1)+3);
    output{i}.ns = pfit(6*(i-1)+4);
    output{i}.koutp = pfit(6*(i-1)+5);
    output{i}.csp = pfit(6*(i-1)+6);
    output{i}.alpha = pfit(19);
end
...
for i = 1:3
    ...
    output{i}.sigcsp = sqrt(Sp(k+6,k+6));
    ...
    disp(['csp: ' num2str(output{i}.csp,'%.1e') ' (' num2str(output{i}.sigcsp,'%.1e') ')']);
end
