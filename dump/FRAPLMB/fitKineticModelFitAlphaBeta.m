function output = fitKineticModelFitAlphaBeta(input)
...
f = @(p) [  ( An(p(1),p(2),p(3),p(4))         - input{1}.A)/input{1}.sigA,...
            s*( Ac(p(1),p(2),p(3),p(4))*p(17)      - input{1}.Ac)/input{1}.sigAc,...
            ( k(p(1),p(2))                   - input{1}.k)/input{1}.sigk,...
            w*( R(p(1),p(2),p(3),p(4))*p(16)  - input{1}.r)/input{1}.sigr,...
            ...
            ( An(p(1),p(5),p(3),p(4))         - input{1}.Almb)/input{1}.sigAlmb,...
            s*( Ac(p(1),p(5),p(3),p(4))*p(17)      - input{1}.Aclmb)/input{1}.sigAclmb,...
            ( k(p(1),p(5))                   - input{1}.klmb)/input{1}.sigklmb,...
            w*( R(p(1),p(5),p(3),p(4))*p(16)  - input{1}.rlmb)/input{1}.sigrlmb,...
            ...
            ( An(p(6),p(7),p(8),p(9))         - input{2}.A)/input{2}.sigA,...
            s*( Ac(p(6),p(7),p(8),p(9))*p(17)      - input{2}.Ac)/input{2}.sigAc,...
            ( k(p(6),p(7))                   - input{2}.k)/input{2}.sigk,...
            w*( R(p(6),p(7),p(8),p(9))*p(16)  - input{2}.r)/input{2}.sigr,...
            ...
            ( An(p(6),p(10),p(8),p(9))        - input{2}.Almb)/input{2}.sigAlmb,...
            s*( Ac(p(6),p(10),p(8),p(9))*p(17)     - input{2}.Aclmb)/input{2}.sigAclmb,...
            ( k(p(6),p(10))                  - input{2}.klmb)/input{2}.sigklmb,...
            w*( R(p(6),p(10),p(8),p(9))*p(16)  - input{2}.rlmb)/input{2}.sigrlmb,...
            ...
            ( An(p(11),p(12),p(13),p(14))     - input{3}.A)/input{3}.sigA,...
            s*( Ac(p(11),p(12),p(13),p(14))*p(17)  - input{3}.Ac)/input{3}.sigAc,...
            ( k(p(11),p(12))                 - input{3}.k)/input{3}.sigk,...
            w*( R(p(11),p(12),p(13),p(14))*p(16)  - input{3}.r)/input{2}.sigr,...
            ...
            ( An(p(11),p(15),p(13),p(14))     - input{3}.Almb)/input{3}.sigAlmb,...
            s*( Ac(p(11),p(15),p(13),p(14))*p(17)  - input{3}.Aclmb)/input{3}.sigAclmb,...
            ( k(p(11),p(15))                 - input{3}.klmb)/input{3}.sigklmb,...
            w*( R(p(11),p(15),p(13),p(14))*p(16)  - input{3}.rlmb)/input{2}.sigrlmb];
...
pinit = [pinit pinit pinit alpha0 beta0]; 
...
J = full(jacobian);
Sp = inv(J'*J);
disp('---------fit +alpha +beta, fit to A_c and R------------');
...
disp(['beta:    ' num2str(output{1}.beta,'%.1e')]);
