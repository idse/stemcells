function output = fitKineticModelNew(input)
...
Acyt = @(kin, kout, cs, ns) kap(kin,kout)*(1-kap(kin,kout))*(1-ns-cs)/(cs + (1-kap(kin,kout))*(1-ns-cs));
...
f = @(p) [  (A(p(1),p(2),p(3),p(4))         - input{1}.A)/input{1}.sigA,...
            (Acyt(p(1),p(2),p(3),p(4))      - input{1}.R)/input{1}.sigR,...
            (Acyt(p(1),p(5),p(3),p(4))      - input{1}.Ap)/input{1}.sigAp,...
            (R(p(1),p(5),p(3),p(4))         - input{1}.Rp)/input{1}.sigRp,...
            (k(p(1),p(2))                   - input{1}.k)/input{1}.sigk,...
            (k(p(1),p(5))                   - input{1}.kp)/input{1}.sigkp,...
            (A(p(6),p(7),p(8),p(9))         - input{2}.A)/input{2}.sigA,...
            (Acyt(p(6),p(7),p(8),p(9))      - input{2}.R)/input{2}.sigR,...
            (A(p(6),p(10),p(8),p(9))        - input{2}.Ap)/input{2}.sigAp,...
            (Acyt(p(6),p(10),p(8),p(9))     - input{2}.Rp)/input{2}.sigRp,...
            (k(p(6),p(7))                   - input{2}.k)/input{2}.sigk,...
            (k(p(6),p(10))                  - input{2}.kp)/input{2}.sigkp,... 
            (A(p(11),p(12),p(13),p(14))     - input{3}.A)/input{3}.sigA,...
            (Acyt(p(11),p(12),p(13),p(14))  - input{3}.R)/input{3}.sigR,...
            (A(p(11),p(15),p(13),p(14))     - input{3}.Ap)/input{3}.sigAp,...
            (Acyt(p(11),p(15),p(13),p(14))  - input{3}.Rp)/input{3}.sigRp,...
...
J = full(jacobian);
Sp = inv(J'*J);
disp('---------fitKineticModel4 (fit single alpha)------------');
for i = 1:3
