function output = fitKineticModel4(input)
...
lb = [lb lb lb 0.5]; % last value is for alpha
ub = [ub ub ub 2];
...
f = @(p) [  (A(p(1),p(2),p(3),p(4))         - input{1}.A)/input{1}.sigA,...
            ...
            (R(p(1),p(5),p(3),p(4),p(16))   - input{1}.Rp)/input{1}.sigRp,...
